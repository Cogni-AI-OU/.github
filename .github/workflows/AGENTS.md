...
| [opencode.yml](opencode.yml) | OpenCode agent invocation via comments or manual triggers | issue_comment, pull_request_review_comment keywords `/oc` or `/opencode`, workflow_dispatch, `workflow_call` |

...
- Read, assimilate, and strictly enforce the invariants defined in the main `AGENTS.md`,
  ...
  *(Note: In GitHub Action runtimes, these catalogs are dynamically populated in the
  environment, e.g., in `~/.instructions/` and `~/.skills/` or as specified by the runtime.)*
